...
void GUI::PrintMessage(string msg) const	//Prints a message on status bar
{
	...
	pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-5), msg); // You may need to change these coordinates later 
	//pWind->DrawString(10, WindHeight - (int) (StatusBarHeight-20), "hi"); // You may need to change these coordinates later 
